			...
			for (int i=0; i < GridRows; i++){	//Counter
					for (int j=0; j < GridCols; j++){	//Counter
						if (i==0 && j==0){//TOP LEFT CORNER
							if ((ourgrid.get_grid(i,j) > ourgrid.get_grid(i,j+1))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+1,j))
								&& (ourgrid.get_grid(i,j)>ourgrid.get_grid(i+1,j+1))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i,j+6))
								&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+1,j+6))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+5,j))
								&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+5,j+1))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+5,j+6))){
								...
								((ourgrid.get_grid(i,j) < ourgrid.get_grid(i,j+1))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i+1,j))
								&& (ourgrid.get_grid(i,j)<ourgrid.get_grid(i+1,j+1))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i,j+6))
								&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i+1,j+6))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i+5,j))
								&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i+5,j+1))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i+5,j+6))){
								...
								if ((ourgrid.get_grid(i,j) > ourgrid.get_grid(i,j-1))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+1,j-1))
								&& (ourgrid.get_grid(i,j)>ourgrid.get_grid(i+1,j))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i,j-6))
								&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+1,j-6))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+5,j-6))
								&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+5,j-1))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+5,j))){
									SQUARE[m]=new square (k*50, l, 0, 255, 255,  50, 50, 255,0,0);//red
									SQUARE[m]->draw(hDC);
									peak[PEAKS] = new point(i,j); //New point object to store location of peak
									PEAKS++; //Incrament
								 ...
								 ((ourgrid.get_grid(i,j) < ourgrid.get_grid(i,j-1))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i+1,j-1))
								&& (ourgrid.get_grid(i,j)<ourgrid.get_grid(i+1,j))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i,j-6))
								&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i+1,j-6))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i+5,j-6))
								&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i+5,j-1))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i+5,j))){
									SQUARE[m]=new square (k*50, l, 0, 255, 255,  50, 50, 0,150,0);//Dark green
							...
							if ((ourgrid.get_grid(i,j) > ourgrid.get_grid(i-1,j))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i-1,j+1))
								&& (ourgrid.get_grid(i,j)>ourgrid.get_grid(i,j+1))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i,j+6))
								&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i-1,j+6))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i-5,j+6))
								...
								((ourgrid.get_grid(i,j) < ourgrid.get_grid(i-1,j))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i-1,j+1))
								&& (ourgrid.get_grid(i,j)<ourgrid.get_grid(i,j+1))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i,j+6))
								&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i-1,j+6))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i-5,j+6))
								&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i-5,j))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i-5,j+1))){
									SQUARE[m]=new square (k*50, l, 0, 255, 255,  50, 50, 0,150,0);//Dark green
							...
							if ((ourgrid.get_grid(i,j) > ourgrid.get_grid(i-1,j-1))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i-1,j))
								&& (ourgrid.get_grid(i,j)>ourgrid.get_grid(i,j-1))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i-1,j-6))
								&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i,j-6))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i-5,j-1))
								&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i-5,j))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i-5,j-6))){
									SQUARE[m]=new square (k*50, l, 0, 255, 255,  50, 50, 255,0,0);//red
									SQUARE[m]->draw(hDC);
									peak[PEAKS] = new point(i,j); //New point object to store location of peak
									PEAKS++; //Incrament
								...
								((ourgrid.get_grid(i,j) < ourgrid.get_grid(i-1,j-1))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i-1,j))
								&& (ourgrid.get_grid(i,j)<ourgrid.get_grid(i,j-1))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i-1,j-6))
								&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i,j-6))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i-5,j-1))
								&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i-5,j))&&(ourgrid.get_grid(i,j)<ourgrid.get_grid(i-5,j-6))){
									SQUARE[m]=new square (k*50, l, 0, 255, 255,  50, 50, 0,150,0);//Dark green
							...
							if ((ourgrid.get_grid(i,j) > ourgrid.get_grid(i,j-1))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+1,j-1))
								&& (ourgrid.get_grid(i,j)>ourgrid.get_grid(i+1,j))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+1,j+1))
								&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i,j+1))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+5,j-1))
								&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+5,j))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+5,j+1))){
									SQUARE[m]=new square (k*50, l, 0, 255, 255,  50, 50, 255,0,0);//red
									SQUARE[m]->draw(hDC);
									peak[PEAKS] = new point(i,j); //New point object to store location of peak
							...
							if ((ourgrid.get_grid(i,j) > ourgrid.get_grid(i-1,j))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i-1,j+1))
								&& (ourgrid.get_grid(i,j)>ourgrid.get_grid(i,j+1))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+1,j+1))
								&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+1,j))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i-1,j+6))
								&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i,j+6))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+1,j+6))){
									SQUARE[m]=new square (k*50, l, 0, 255, 255,  50, 50, 255,0,0);//red
									SQUARE[m]->draw(hDC);
									peak[PEAKS] = new point(i,j); //New point object to store location of peak
									PEAKS++; //Incrament
							...
							if ((ourgrid.get_grid(i,j) > ourgrid.get_grid(i-1,j-1))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i-1,j))
								&& (ourgrid.get_grid(i,j)>ourgrid.get_grid(i-1,j+1))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i,j+1))
								&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+1,j+1))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+1,j))
								&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i+1,j-1))&&(ourgrid.get_grid(i,j)>ourgrid.get_grid(i,j-1))){
